...
mixin _$AuthSession {
 ...
 String get accessToken; String get refreshToken; String? get tokenType; String? get redirectUrl;
...
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,tokenType,redirectUrl);

@override
String toString() {
  return 'AuthSession(accessToken: $accessToken, refreshToken: $refreshToken, tokenType: $tokenType, redirectUrl: $redirectUrl)';
}
...
@useResult
$Res call({
 String accessToken, String refreshToken, String? tokenType, String? redirectUrl
});
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? refreshToken = null,Object? tokenType = freezed,Object? redirectUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String? tokenType,  String? redirectUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.redirectUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String? tokenType,  String? redirectUrl)  $default,) {final _that = this;
switch (_that) {
case _AuthSession():
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.redirectUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  String? tokenType,  String? redirectUrl)?  $default,) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.redirectUrl);case _:
  return null;
...
class _AuthSession implements AuthSession {
  const _AuthSession({required this.accessToken, required this.refreshToken, this.tokenType, this.redirectUrl});
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? tokenType = freezed,Object? redirectUrl = freezed,}) {
